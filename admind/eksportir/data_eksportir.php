...
<?php 
    ...
    $query = mysqli_query($koneksi,"SELECT * FROM eksportir");
	$no = 1;
?>
<div class="topnav">
...
<div style="padding-left:16px">
  ...
  ?>
  <br>
  <a href="form_eksportir.php"><button   style="width: 10%;background-color:blue">Tambah Data</button></a>
  ...
  <tr>
    ...
    <tr>
        <td><?php echo $no++;?></td>
        <td><?php echo $row['nama_eksportir'];?></td>
        <td>
            <a href="form_edit_eksportir.php?id=<?php echo $row['id'];?>">Edit</a> |
            <a href="hapus_eksportir.php?id=<?php echo $row['id'];?>">Hapus</a> 
        </td>
    </tr>
    <?php 
        }
